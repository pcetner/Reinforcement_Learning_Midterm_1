...
epsilon_decay = 0.01     # Decay rate for epsilon
...
def update(t):
    ...
    # Adjust the legend position to include the value of epsilon
    axs[1].legend(loc='upper left', bbox_to_anchor=(1, 1), title=f"Legends (ε={epsilon:.4f})", fontsize='medium')
...
anim.save('epsilon_decay_algorithm_animation.mp4', writer='ffmpeg', fps=fps)
